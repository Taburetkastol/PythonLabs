...
def load():
    try:
        ...
        book_array = [book.Book(library.Library(str(file.readline())), str(file.readline()), int(file.readline()),
                                int(file.readline()),
                                date.Date(int(file.readline()), int(file.readline()), int(file.readline())))]
        for item in range(1, l):
            book_array.append(
                book.Book(library.Library(str(file.readline())), str(file.readline()), int(file.readline()),
                          int(file.readline()),
                          date.Date(int(file.readline()), int(file.readline()), int(file.readline()))))
        return book_array
    except:
